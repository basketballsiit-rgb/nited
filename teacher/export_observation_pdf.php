...
$teacher_sig = $supervision['teacher_signature_path'] ?? '';
...
$html .= 'ครูผู้สอน / ผู้รับการนิเทศ<br>';
if (!empty($supervision['teacher_signed_at'])) {
    $html .= '<span style="font-size: 9pt; color: #555;">วันที่รับทราบ: ' . date('d/m/Y', strtotime($supervision['teacher_signed_at'])) . '</span>';
}
$html .= '</td>';
$html .= '</tr>';
$html .= '</table>';
